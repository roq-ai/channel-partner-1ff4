...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'partner-manager', 'support-staff', 'sales-representative'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Deal', path: '/deals', entity: 'deal', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
